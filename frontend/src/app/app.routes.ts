...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/create-url/create-url-page.component').then(
            (module) => module.CreateUrlPageComponent,
          ),
      },
      {
        path: 'urls',
        ...
        loadComponent: () =>
          import('./features/url-management/url-management-page.component').then(
            (module) => module.UrlManagementPageComponent,
          ),
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/url-management/url-details-page.component').then(
            (module) => module.UrlDetailsPageComponent,
          ),
      },
      {
        path: 'analytics',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/project-review/project-review-page.component').then(
            (module) => module.ProjectReviewPageComponent,
          ),
      },
    ],
  },
  {
    ...
    loadComponent: () =>
      import('./shared/components/not-found-page.component').then(
